                                    ...
                                    <tr>
                                        ...
                                        <td data-id="<?= $rid ?>" data-year="<?= $y ?>">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <button class="btn btn-outline-secondary" onclick="editSpecialRow(this, 'NetWorth', 'networthID')">✎</button>
                                            </div>
                                        </td>
                                        <?php endfor; ?>
                                    </tr>
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="<?= $rid ?>" data-type-id="<?= $id ?>">
                                        ...
                                        <td><button class="btn btn-sm btn-outline-secondary" onclick="editSpecialRow(this, 'Equipment', 'equipmentRecordID')">Save</button></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
