...
$pendingAttention = $counts['pending approval'] ?? 0;
...
// Show all forms by default for head view; filters apply below.
    ...
    <div class="container-main">
        ...
        <div class="cards">
            ...
            <div class="card pending">
                <h3><?php echo htmlspecialchars($counts['pending approval']); ?></h3>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><?php
                                    // Display a friendly name for the head's department column
                                    $deptFriendly = 'Department';
                                    if (!empty($deptColumn)) {
                                        switch ($deptColumn) {
                                            case 'financeDepartmentStatus': $deptFriendly = 'Finance'; break;
                                            case 'projectDepartmentStatus': $deptFriendly = 'Project'; break;
                                            case 'legalDepartmentStatus': $deptFriendly = 'Legal'; break;
                                            case 'planDepartmentStatus': $deptFriendly = 'Plan'; break;
                                            default: $deptFriendly = 'Department';
                                        }
                                    }
                                    echo htmlspecialchars($deptFriendly);
                                ?></th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($forms as $form): ?>
                                <?php
                                    ...
                                    // Determine the department status for this head
                                    $deptStatus = 'not review';
                                    if (!empty($deptColumn) && array_key_exists($deptColumn, $form)) {
                                        $deptStatus = $form[$deptColumn] ?? 'not review';
                                    }
                                ?>
                                <tr>
                                    ...
                                    <td><span class="<?php echo status_pill_class($deptStatus); ?>"><?php echo htmlspecialchars(normalize_status($deptStatus)); ?></span></td>
                                    <td>
